                ...
                foreach ($product->getData('cart') as $item) :
                    ...
                    $subtotal[] = array_map(function ($item) {
                        ...
                        <div class="row border-top py-3 mt-3">
                            <div class="col-sm-2">
                                <img src="<?php echo $item['item_image']; ?>" style="height: 120px;" alt="product"
                                     class="img-fluid">
                            </div>
                            <div class="col-sm-8">
                                ...
                                <div class="qty d-flex pt-2">
                                    <div class="d-flex font-rale w-25">
                                        ...
                                        <input type="text" data-id="pro1" class="qty_input border px-2 w-100 bg-light"
                                               disabled
                                    ...
                                    <form method="post">
                                        ...
                                        <button type="submit" name="delete-cart-submit" class="btn font-baloo text-danger px-3 border-right">
                                            Delete
                                        </button>
                                    </form>
            ...
            <div class="col-sm-3">
                <div class="sub-total border text-center mt-2">
                    ...
                    <div class="border-top py-4">
                        <h5 class="font-baloo font-size-20">Subtotal (<?php echo count($subtotal); ?> items):&nbsp;
                            <span
