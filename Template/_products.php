                ...
                <div class="row">
                    ...
                    <div class="col-sm-6 py-5">
                        ...
                        <table class="my-3">
                            ...
                            <tr class="font-size-14 font-rale">
                                <td>You Save:</td>
                                <td><span class="font-size-20 text-danger">$10</span></td>
                            </tr>
                        </table>
                        ...
                        <div id="policy">
                            <div class="d-flex">
                                ...
                                <div class="return text-center mr-5">
                                    ...
                                    <a href="#" class="font-rale font-size-12">Khorezm <br> Delivered</a>
                                </div>
                                <div class="return text-center mr-5">
                                    <div class="font-size-20 my-2 color-second">
                            ...
                            <div id="order-details" class="font-rale d-flex flex-column text-dark">
                                ...
                                <small>Sold by <a href="#">Khorezm Electronics </a>(4.5 out of 5 | 18.198
                                    ratings)</small>
                                ...
                                <div class="col-6">
                                    ...
                                    <div class="qty d-flex">
                                        ...
                                        <div class="px-4 d-flex font-rale">
                                            <button class="qty-up border bg-light" data-id="prod1"><i
                                                        class="fas fa-angle-up"></i></button>
                                            <input type="text" data-id="prod1"
                                                   class="qty_input border px-2 w-50 bg-light" disabled
                                                   value="1" placeholder="1">
                                            <button class="qty-down border bg-light" data-id="prod1"><i
                    ...
                    <div class="col-12">
                        ...
                        <hr>
                        <p class="font-rale font-size-14">Lorem ipsum dolor sit amet, consectetur adipisicing elit. A,
                            adipisci amet atque autem corporis,
                            deserunt distinctio dolorum esse harum ipsam magni minima minus natus nemo nihil nisi nobis
                            non
                            nostrum obcaecati pariatur placeat quasi quibusdam quidem quod repellat repudiandae rerum
                            sint
                            suscipit veniam veritatis voluptate.</p>
                        <p class="font-rale font-size-14">Lorem ipsum dolor sit amet, consectetur adipisicing elit. A,
                            adipisci amet atque autem corporis,
                            deserunt distinctio dolorum esse harum ipsam magni minima minus natus nemo nihil nisi nobis
                            non
